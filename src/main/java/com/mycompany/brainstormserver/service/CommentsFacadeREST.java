...
import com.mycompany.brainstormserver.Comments;
...
public class CommentsFacadeREST extends AbstractFacade<Comments> {
    @PersistenceContext(unitName = "com.mycompany_BrainstormServer_war_1.0-SNAPSHOTPU")
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") String id, Comments entity) {
        super.edit(entity);
    }
    ...
    public Comments find(@PathParam("id") String id) {
